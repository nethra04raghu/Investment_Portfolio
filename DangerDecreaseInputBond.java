/*
input percent for danger decrease for asset class bond 
 */
...
public class DangerDecreaseInputBond extends JFrame implements ActionListener
{
  // label 
  ...
  public DangerDecreaseInputBond()
  {
  ...
  public void actionPerformed(ActionEvent e)
  {
    ...
    if (command == enterButton)
    {
      try
      {
        ...
        // query 
        String query = "UPDATE DangerDecrease SET Bond = ? WHERE Constant = ?";

        // parsing and setting value 
