/*
comparing values for asset class bond 
 */
...
public class EstimateCompareBond extends JFrame implements ActionListener
{
  // label 
  ...
  double sumCurrentBond;

  public EstimateCompareBond()
  {
    ...
    sumCurrentBond = Double.parseDouble(currentMoneyData.get(0).get(1));
    
    // constructing text
    this.estimateCompareDisplayText = new JLabel("<html><center> Your Estimate Was: " 
      + objEstCalc.getBondEstimateMoney() +" </center></html>", SwingConstants.CENTER); 
    ...
    this.estimateCompareDisplayText2 = new JLabel("<html><center> The Actual Value Is: " 
      + sumCurrentBond + " </center></html>", SwingConstants.CENTER); 
