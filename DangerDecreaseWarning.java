/*
warning frame from when danger decrease levels are reached 
 */
...
public class DangerDecreaseWarning extends JFrame implements ActionListener
{
  // labels 
  ...
  public DangerDecreaseWarning(String flag)
  {
    super("Rebalance");
    ...
    // constructing labels 
    this.turnoverText = new JLabel("DECREASE WARNING", SwingConstants.CENTER);
