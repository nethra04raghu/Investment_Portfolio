/*
comparing estimate for asset class fixed income 
 */
...
public class EstimateCompareFixed extends JFrame implements ActionListener
{
  // label 
  ...
  double sumCurrentFixed;

  public EstimateCompareFixed()
  {
    ...
    sumCurrentFixed = Double.parseDouble(currentMoneyData.get(0).get(3));
    
    // constructing text
    this.estimateCompareDisplayText = new JLabel("<html><center> Your Estimate Was: " 
      + objEstCalc.getFixedEstimateMoney() +" </center></html>", SwingConstants.CENTER); 
    ...
    this.estimateCompareDisplayText2 = new JLabel("<html><center> The Actual Value Is: " 
      + sumCurrentFixed + " </center></html>", SwingConstants.CENTER); 
