/*
Displaying the table for users to look at their assets for bonds 
 */
...
public class BondTable extends JFrame implements ActionListener
{
  ...
  public BondTable(String dbName, String tableName, String[] columnNames)
  {
    super("Bond Table");
    ...
    // creating object of javadb & set connection 
