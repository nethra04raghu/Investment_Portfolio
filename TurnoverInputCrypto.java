/*
frame to input percent for crypto 
 */
...
public class TurnoverInputCrypto extends JFrame implements ActionListener
{
  // label and textfield 
  ...
  public void actionPerformed(ActionEvent e)
  {
    ...
    if (command == enterButton)
    {
      try
      {
        ...
        String query = "UPDATE Turnover SET Crypto = ? WHERE Constant = ?";

        updateCryptoTurn = Double.parseDouble(turnoverInputTextField.getText());
        ...
        try
        {
          ...
          ps.setDouble(1, updateCryptoTurn);
