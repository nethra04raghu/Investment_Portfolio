/*
estimate comparison for asset class bond 
 */
...
public class EstimateInputBond extends JFrame implements ActionListener
{
  ...
  public double bondEstimateRaw;

  public EstimateInputBond()
  {
    super("Estimate Input Bond");
  ...
  public void actionPerformed(ActionEvent e)
  {
    ...
    if (command == enterButton)
    {
      try
      {
        ...
        // sql statement 
        String query = "UPDATE Estimate SET Bond = ? WHERE Constant = ?";

        updateBondEst = Double.parseDouble(estimateInputTextField.getText());
