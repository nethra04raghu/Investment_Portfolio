/*
frame for inputting turnover percent for stock 
 */
...
public class TurnoverInputStock extends JFrame implements ActionListener
{
  // label and textfield 
  ...
  public void actionPerformed(ActionEvent e)
  {
    ...
    if (command == enterButton)
    {
      try
      {
        ...
        String query = "UPDATE Turnover SET Stock = ? WHERE Constant = ?";

        updateStockTurn = Double.parseDouble(turnoverInputTextField.getText());
        ...
        try
        {
          ...
          ps.setDouble(1, updateStockTurn);
