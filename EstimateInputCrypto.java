/*
estimate input for asset class crypto
 */
...
public class EstimateInputCrypto extends JFrame implements ActionListener
{
  ...
  public double cryptoEstimateRaw; 
  
  public EstimateInputCrypto()
  {
    super("Estimate Input Crypto");
  ...
  public void actionPerformed(ActionEvent e)
  {
    ...
    if (command == enterButton)
    {
      try
      {
        ...
        // sql statement 
        String query = "UPDATE Estimate SET Crypto = ? WHERE Constant = ?";

        updateCryptoEst = Double.parseDouble(estimateInputTextField.getText());
        ...
        try
        {
          ...
          ps.setDouble(1, updateCryptoEst);
