...
public class BondDelete extends JFrame implements ActionListener
{
  ...
  public BondDelete()
  {
    ...
    // constructing button panels + adding buttons
  ...
  public void actionPerformed(ActionEvent e)
  {
    ...
    {
      // SQL statement 
      String query = "DELETE FROM Bonds WHERE Name = ?";
