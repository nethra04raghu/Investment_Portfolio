...
public class FixedIncomeUpdate extends JFrame implements ActionListener
{
  ...
  public FixedIncomeUpdate()
  {
    super("Update Asset for Fixed Income");
  ...
  public void actionPerformed(ActionEvent e)
  {
    ...
    // if user clicks then program updates
    if (command == enterButton)
    {
      // sql statement 
      String query = "UPDATE FixedIncome SET Current_Price = ? WHERE Name = ?";
