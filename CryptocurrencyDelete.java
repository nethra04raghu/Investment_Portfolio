...
public class CryptocurrencyDelete extends JFrame implements ActionListener
{
  ...
  public CryptocurrencyDelete()
  {
    super("Delete Asset for Cryptocurrency");
  ...
  public void actionPerformed(ActionEvent e)
  {
    ...
    {
      // sql statement 
      String query = "DELETE FROM Crypto WHERE Name = ?";
