/*
input frame for turnover percent for fixed income 
 */
...
public class TurnoverInputFixed extends JFrame implements ActionListener
{
  // label and textfield 
  ...
  public void actionPerformed(ActionEvent e)
  {
    ...
    if (command == enterButton)
    {
      try
      {
        ...
        String query = "UPDATE Turnover SET Fixed = ? WHERE Constant = ?";

        updateFixedTurn = Double.parseDouble(turnoverInputTextField.getText());
        ...
        try
        {
          ...
          ps.setDouble(1, updateFixedTurn);
