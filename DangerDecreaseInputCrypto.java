/*
input for percentage for asset class cryptocurrency 
 */
...
public class DangerDecreaseInputCrypto extends JFrame implements ActionListener
{
  // label 
  ...
  public DangerDecreaseInputCrypto()
  {
  ...
  public void actionPerformed(ActionEvent e)
  {
    ...
    if (command == enterButton)
    {
      try
      {
        ...
        // query 
        String query = "UPDATE DangerDecrease SET Crypto = ? WHERE Constant = ?";
