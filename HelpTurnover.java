/*
Frame if user needs help with how to navigate turnover frame 
 */
...
public class HelpTurnover extends JFrame
{
  ...
  public HelpTurnover()
  {
    ...
    this.helpMessage = new JLabel("<html><center>Here you can input the turnover "
      + "percentage of your asset class", SwingConstants.CENTER);
    helpMessage.setFont(Welcome.WORD_FONT);
    helpMessage.setForeground(Welcome.EGGSHELL);

    this.help2Message = new JLabel("<html><center>Note: when your asset class "
      + "has reached this percentage, we will notify you !</center></html>",
