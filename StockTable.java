/*
Displaying the table for users to look at their assets for stocks 
 */
...
public class StockTable extends JFrame implements ActionListener
{
  ...
  public StockTable(String dbName, String tableName, String[] columnNames)
  {
    super("Stock Table");
  ...
  public static void main(String[] args)
  {
    ...
    // query 
    String dbQuery = "INSERT INTO Stocks VALUES (?,?,?,?,?)";
