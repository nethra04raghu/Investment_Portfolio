...
public class FixedIncomeAdd extends JFrame implements ActionListener
{
  ...
  public FixedIncomeAdd()
  {
    super("Add Asset for Fixed Income");
  ...
  public void actionPerformed(ActionEvent e)
  {
    ...
    if (command == enterButton)
    {
      ...
      try
      {
        ...
        // testing to see if these are true or not and act accordingly
