/*
input values for danger decrease for class fixed income 
 */
...
public class DangerDecreaseInputFixed extends JFrame implements ActionListener
{
  // label 
  ...
  public DangerDecreaseInputFixed()
  {
  ...
  public void actionPerformed(ActionEvent e)
  {
    ...
    if (command == enterButton)
    {
      try
      {
        ...
        // query 
        String query = "UPDATE DangerDecrease SET Fixed = ? WHERE Constant = ?";
